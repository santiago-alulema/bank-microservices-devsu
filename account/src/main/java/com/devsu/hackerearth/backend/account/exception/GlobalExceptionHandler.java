...
import com.devsu.hackerearth.backend.account.helper.BuildResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDto> handlerGeneric(Exception ex) {
        return BuildResponse.build(HttpStatus.INTERNAL_SERVER_ERROR, "Unexpected error occurred");
    }
